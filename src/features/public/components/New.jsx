  ...
  useEffect(() => {
    ...
    return (
      ...
      <div className="mb-3">
          ...
          <p className="text-3xl font-light">နောက်ဆုံးရ သေဆုံး/ဒဏ်ရာရစာရင်း</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="flex flex-col">
          <h3 className='text-xl mb-4 font-medium'>သေဆုံး</h3>
