      ...
      <div className=" flex gap-3 items-center">
        <div className=" flex items-center gap-2">
          ...
          <select
            ...
            className="flex items-center cursor-pointer justify-center h-10 text-sm font-medium border-y border rounded-lg border-gray-200  dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white disabled:opacity-50 disabled:pointer-events-none"
            value={currentLimit}
          >
